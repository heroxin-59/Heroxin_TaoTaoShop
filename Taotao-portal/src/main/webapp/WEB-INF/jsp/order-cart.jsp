...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="Heroxin"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="15234029443"/>
		<input type="hidden" name="orderShipping.receiverState" value="山西省"/>
		<input type="hidden" name="orderShipping.receiverCity" value="太原市"/>
		<input type="hidden" name="orderShipping.receiverDistrict" value="万柏林区"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="翻斗大街翻斗花园114514号"/>
</form>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">Heroxin</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">152****9443</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">山西 太原市 尖草坪区</div>
						<div class="adr-m" limit="30">翻斗大街翻斗花园114514号</div>
